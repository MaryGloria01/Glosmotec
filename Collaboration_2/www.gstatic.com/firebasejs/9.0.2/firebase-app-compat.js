! function(e, t) {
    ...
    var i = (t.prototype.wrapCallback = function(n) {
        var r = this;
        return function(e, t) {
    ...
    function p(e, t, n) {
        ...
        return t.code = e, t.customData = n, t.name = c, Object.setPrototypeOf(t, p.prototype), Error.captureStackTrace && Error.captureStackTrace(t, h.prototype.create), t
    }
    var h = (d.prototype.create = function(e) {
    ...
    var I = (w.prototype.next = function(t) {
    ...
    function E() {}
    var _ = (O.prototype.setInstantiationMode = function(e) {
    ...
    var C = "[DEFAULT]",
        N = (L.prototype.get = function(e) {
            ...
            if (this.component = e, this.shouldAutoInitialize()) {
                ...
                try {
                    for (var r = f(this.instancesDeferred.entries()), i = r.next(); !i.done; i = r.next()) {
                        var o = u(i.value, 2),
                            a = o[0],
                            s = o[1],
            ...
            this.instancesDeferred.delete(e = void 0 === e ? C : e), this.instancesOptions.delete(e), this.instances.delete(e)
            ...
            return e(this, void 0, void 0, function() {
                ...
                return n(this, function(e) {
                    switch (e.label) {
                        case 0:
                            return t = Array.from(this.instances.values()), [4, Promise.all(a(a([], u(t.filter(function(e) {
            ...
            try {
                for (var a = f(this.instancesDeferred.entries()), s = a.next(); !s.done; s = a.next()) {
                    var c = u(s.value, 2),
                        l = c[0],
                        p = c[1];
            ...
            if (!e && this.component && (e = this.component.instanceFactory(this.container, {
                    ...
                    options: r
                }), this.instances.set(t, e), this.instancesOptions.set(t, r), this.invokeOnInitCallbacks(e, t), this.component.onInstanceCreated)) try {
                this.component.onInstanceCreated(this.container, t, e)
            } catch (e) {}
            return e || null
        }, L.prototype.normalizeInstanceIdentifier = function(e) {
            return void 0 === e && (e = C), !this.component || this.component.multipleInstances ? e : C
    ...
    var S = (A.prototype.addComponent = function(e) {
    ...
    var k = {
        ...
        j = D.INFO,
        z = ((le = {})[D.DEBUG] = "log", le[D.VERBOSE] = "log", le[D.INFO] = "info", le[D.WARN] = "warn", le[D.ERROR] = "error", le),
        F = (Object.defineProperty(T.prototype, "logLevel", {
            get: function() {
            ...
            this._userLogHandler && this._userLogHandler.apply(this, a([this, D.DEBUG], e)), this._logHandler.apply(this, a([this, D.DEBUG], e))
        }, T.prototype.log = function() {
            for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
            this._userLogHandler && this._userLogHandler.apply(this, a([this, D.VERBOSE], e)), this._logHandler.apply(this, a([this, D.VERBOSE], e))
        }, T.prototype.info = function() {
            for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
            this._userLogHandler && this._userLogHandler.apply(this, a([this, D.INFO], e)), this._logHandler.apply(this, a([this, D.INFO], e))
        }, T.prototype.warn = function() {
            for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
            this._userLogHandler && this._userLogHandler.apply(this, a([this, D.WARN], e)), this._logHandler.apply(this, a([this, D.WARN], e))
        }, T.prototype.error = function() {
            for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
            this._userLogHandler && this._userLogHandler.apply(this, a([this, D.ERROR], e)), this._logHandler.apply(this, a([this, D.ERROR], e))
        }, T);

    function T(e) {
        this.name = e, this._logLevel = j, this._logHandler = P, this._userLogHandler = null, R.push(this)
    }

    function x(a, t) {
        for (var e = 0, n = R; e < n.length; e++) ! function(e) {
            var o = null;
    ...
    function Y(t, n) {
        try {
            ...
            M.debug(`Component ${n.name} failed to register with FirebaseApp ${t.name}`, e)
        }
    }
    ...
    function J(e) {
        var t = e.name;
        if (W.has(t)) return M.debug(`There were multiple attempts to register component ${t}.`), !1;
        W.set(t, e);
    ...
    class q {
        ...
        checkDestroyed() {
            if (this.isDeleted) throw Z.create("app-deleted", {
                appName: this._name
            })
        }
    }
    ...
    function ee(e, t = {}) {
        ...
        const r = n.name;
        if ("string" != typeof r || !r) throw Z.create("bad-app-name", {
            appName: String(r)
        });
        t = G.get(r);
        if (t) {
    ...
    async function te(e) {
        var t = e.name;
        G.has(t) && (G.delete(t), await Promise.all(e.container.getProviders().map(e => e.delete())), e.isDeleted = !0)
    }
    ...
    function ne(e, t, n) {
        ...
        if (e || n) {
            ...
            return e && o.push(`library name "${i}" contains illegal characters (whitespace or "/")`), e && n && o.push("and"), n && o.push(`version name "${t}" contains illegal characters (whitespace or "/")`), void M.warn(o.join(" "))
        }
        J(new _(`${i}-version`, () => ({
            library: i,
            version: t
    ...
    function re(e, t) {
        if (null !== e && "function" != typeof e) throw Z.create("invalid-log-argument");
        x(e, t)
    }
    ...
    J(new _("platform-logger", e => new H(e), "PRIVATE")), ne($, "0.7.0", B), ne("fire-js", "");
    ...
    class ae {
        constructor(e, t) {
            this._delegate = e, this.firebase = t, Y(e, new _("app-compat", () => this, "PUBLIC")), this.container = e.container
        }
        get automaticDataCollectionEnabled() {
        ...
        delete() {
            ...
            }).then(() => (this.firebase.INTERNAL.removeApp(this.name), te(this._delegate)))
        }
        _getService(e, t = V) {
    ...
    function ce(i) {
                ...
                INTERNAL: {
                    registerComponent: function(n) {
                        const r = n.name,
                            t = r.replace("-compat", ""); {
                            var e;
                            J(n) && "PUBLIC" === n.type && (e = (e = a()) => {
                                if ("function" != typeof e[t]) throw se.create("invalid-app-argument", {
                                    appName: r
                                });
                                return e[t]()
                            }, void 0 !== n.serviceProps && s(e, n.serviceProps), o[t] = e, i.prototype[t] = function(...e) {
        ...
        function a(e) {
            if (e = e || V, !v(n, e)) throw se.create("no-app", {
                appName: e
            });
            return n[e]
        }
  ...
  `);
        ...
        ue && 0 <= ue.indexOf("LITE") && pe.warn(`
    Warning: You are trying to load Firebase while using Firebase Performance standalone script.
    You should load Firebase Performance with this instance of Firebase to avoid loading duplicate code.
    `)
    }
    const fe = le;
    ne("@firebase/app-compat", "0.1.1", void 0);
    return fe.registerVersion("firebase", "9.0.2", "app-compat-cdn"), fe
});
