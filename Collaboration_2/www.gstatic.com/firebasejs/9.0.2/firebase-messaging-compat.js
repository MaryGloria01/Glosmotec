    ...
    try {
        ! function() {
            ...
            function s(e, t, n) {
                ...
                return t.code = e, t.customData = n, t.name = a, Object.setPrototypeOf(t, s.prototype), Error.captureStackTrace && Error.captureStackTrace(t, c.prototype.create), t
            }
            var c = (n.prototype.create = function(e) {
                for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
                var i, o = t[0] || {},
                    a = this.service + "/" + e,
                    e = this.errors[e],
                    e = e ? (i = o, e.replace(u, function(e, t) {
                        var n = i[t];
            ...
            var d = (l.prototype.setInstantiationMode = function(e) {
            ...
            function g(n, i, o) {
                var a, e = new Promise(function(e, t) {
            ...
            function m(e, i, t, n) {
                n.forEach(function(n) {
                    n in t.prototype && (e.prototype[n] = function() {
                        return e = this[i], (t = g(e, n, arguments)).then(function(e) {
            ...
            h(b, "_index", ["name", "keyPath", "multiEntry", "unique"]), w(b, "_index", IDBIndex, ["get", "getKey", "getAll", "getAllKeys", "count"]), m(b, "_index", IDBIndex, ["openCursor", "openKeyCursor"]), h(v, "_cursor", ["direction", "key", "primaryKey", "value"]), w(v, "_cursor", IDBCursor, ["update", "delete"]), ["advance", "continue", "continuePrimaryKey"].forEach(function(n) {
                n in IDBCursor.prototype && (v.prototype[n] = function() {
                    var t = this,
                        e = arguments;
                    return Promise.resolve().then(function() {
                        return t._cursor[n].apply(t._cursor, e), f(t._request).then(function(e) {
            ...
            }, h(k, "_store", ["name", "keyPath", "indexNames", "autoIncrement"]), w(k, "_store", IDBObjectStore, ["put", "add", "delete", "clear", "get", "getAll", "getKey", "getAllKeys", "count"]), m(k, "_store", IDBObjectStore, ["openCursor", "openKeyCursor"]), y(k, "_store", IDBObjectStore, ["deleteIndex"]), I.prototype.objectStore = function() {
                return new k(this._tx.objectStore.apply(this._tx, arguments))
            }, h(I, "_tx", ["objectStoreNames", "mode"]), y(I, "_tx", IDBTransaction, ["abort"]), S.prototype.createObjectStore = function() {
                return new k(this._db.createObjectStore.apply(this._db, arguments))
            }, h(S, "_db", ["name", "version", "objectStoreNames"]), y(S, "_db", IDBDatabase, ["deleteObjectStore", "close"]), _.prototype.transaction = function() {
                return new I(this._db.transaction.apply(this._db, arguments))
            }, h(_, "_db", ["name", "version", "objectStoreNames"]), y(_, "_db", IDBDatabase, ["close"]), ["openCursor", "openKeyCursor"].forEach(function(o) {
                [k, b].forEach(function(e) {
                    o in e.prototype && (e.prototype[o.replace("open", "iterate")] = function() {
                ...
                e.prototype.getAll || (e.prototype.getAll = function(e, n) {
                    ...
                    return new Promise(function(t) {
                        i.iterateCursor(e, function(e) {
                            e ? (o.push(e.value), void 0 === n || o.length != n ? e.continue() : t(o)) : t(o)
                        })
                    })
                })
            });
            ...
            function Y(e, t) {
                ...
                Q(e, t),
                    function(e, t) {
                        const n = function() {
                            !Z && "BroadcastChannel" in self && (Z = new BroadcastChannel("[Firebase] FID Change"), Z.onmessage = e => {
            ...
            async function oe(e, t) {
                ...
                const i = await ie(),
                    ...
                    a = o.objectStore(te);
                var r = await a.get(n);
                return await a.put(t, n), await o.complete, r && r.fid === t.fid || Y(e, t.fid), t
            }
            async function ae(e) {
                e = J(e);
                const t = await ie(),
            ...
            async function re(e, t) {
                ...
                var r = await a.get(n),
                    t = t(r);
                return void 0 === t ? await a.delete(n) : await a.put(t, n), await o.complete, !t || r && r.fid === t.fid || Y(e, t.fid), t
            }
            async function se(t) {
                let n;
                var e = await re(t, e => {
                    ...
                    }(e), e = function(e, t) {
                        {
                            if (0 !== t.registrationStatus) return 1 === t.registrationStatus ? {
                                ...
                                registrationPromise: async function(e) {
                                    let t = await ce(e);
                                    for (; 1 === t.registrationStatus;) await H(100), t = await ce(e);
                            ...
                            t = {
                                ...
                                try {
                                    ...
                                    throw B(e) && 409 === e.customData.serverCode ? await ae(t) : await oe(t, {
                                        fid: n.fid,
                                        registrationStatus: 0
                                    }), e
                                }
            ...
            function ue(e) {
                return 1 === (t = e).registrationStatus && t.registrationTime + j < Date.now() ? {
                    fid: e.fid,
                    registrationStatus: 0
                } : e;
                var t
            ...
            async function de(i, o = !1) {
                ...
                var e = await re(i.appConfig, e => {
                    ...
                    if (o || 2 !== (t = n).requestStatus || function(e) {
                        ...
                        if (1 === n.requestStatus) return a = async function(e, t) {
                            let n = await le(e.appConfig);
                            for (; 1 === n.authToken.requestStatus;) await H(100), n = await le(e.appConfig);
                            var i = n.authToken;
                        ...
                        return a = async function(t, n) {
                            try {
                                ...
                                throw !B(e) || 401 !== e.customData.serverCode && 404 !== e.customData.serverCode ? (n = Object.assign(Object.assign({}, n), {
                                    authToken: {
                                        requestStatus: 0
                                    }
                                }), await oe(t.appConfig, n)) : await ae(t.appConfig), e
                            }
                        }(i, n), n
                    }
                    return e
            ...
            function le(e) {
                return re(e, e => {
                    if (!fe(e)) throw x.create("not-registered");
                    var t = e.authToken;
                    return 1 === (t = t).requestStatus && t.requestTime + j < Date.now() ? Object.assign(Object.assign({}, e), {
                        authToken: {
                            requestStatus: 0
                        }
                    }) : e
            ...
            Lt._registerComponent(new d(we, e => {
            ...
            }, "PUBLIC")), Lt._registerComponent(new d("installations-internal", e => {
                e = e.getProvider("app").getImmediate();
            ...
            }, "PRIVATE")), Lt.registerVersion("@firebase/installations", O);
            const ye = "/firebase-messaging-sw.js",
                me = "/firebase-cloud-messaging-push-scope",
                be = "BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",
            ...
            }(O = {})[O.DATA_MESSAGE = 1] = "DATA_MESSAGE", O[O.DISPLAY_NOTIFICATION = 3] = "DISPLAY_NOTIFICATION", (O = K = K || {}).PUSH_RECEIVED = "push-received", O.NOTIFICATION_CLICKED = "notification-clicked";
            ...
            async function je(a) {
                ...
                const e = await T(Te, Ce, async e => {
                    ...
                    if (!(e.oldVersion < 2) && e.objectStoreNames.contains(Oe)) {
                        ...
                        var n, i = await o.index("fcmSenderId").get(a);
                        await o.clear(), i && (2 === e.oldVersion ? (n = i).auth && n.p256dh && n.endpoint && (r = {
                            token: n.fcmToken,
                            ...
                            subscriptionOptions: {
                                ...
                                endpoint: n.endpoint,
                                swScope: n.swScope,
                                vapidKey: "string" == typeof n.vapidKey ? n.vapidKey : _e(n.vapidKey)
                            }
                        }) : 3 === e.oldVersion ? (n = i, r = {
                            token: n.fcmToken,
                ...
                return e.close(), await C(Te), await C("fcm_vapid_details_db"), await C("undefined"),
                    function(e) {
            ...
            async function Ve(e) {
                ...
                if (s) {
                    if (n = s.subscriptionOptions, i = r.vapidKey === n.vapidKey, o = r.endpoint === n.endpoint, a = r.auth === n.auth, n = r.p256dh === n.p256dh, i && o && a && n) return Date.now() >= s.createTime + Re ? async function(t, e) {
                        try {
                            var n = await async function(e, t) {
                                    ...
                                    let o;
                                    try {
                                        const a = await fetch(`${Fe(e.appConfig)}/${t.token}`, i);
                                        o = await a.json()
                                    } catch (e) {
            ...
            async function He(e) {
                ...
                t && (await $e(e.firebaseDependencies, t.token), await async function(e) {
                    e = xe(e);
                    const t = await Ke(),
            ...
            function Ue(e) {
                ...
                return n = o, (i = e).notification && (n.notification = {}, (t = i.notification.title) && (n.notification.title = t), (t = i.notification.body) && (n.notification.body = t), (i = i.notification.image) && (n.notification.image = i)), n = o, (i = e).data && (n.data = i.data), n = o, (i = e).fcmOptions && (n.fcmOptions = {}, (e = i.fcmOptions.link) && (n.fcmOptions.link = e), (i = i.fcmOptions.analytics_label) && (n.fcmOptions.analyticsLabel = i)), o
            }
            ...
            Ge("hts/frbslgigp.ogepscmv/ieo/eaylg", "tp:/ieaeogn-agolai.o/1frlglgc/o"), Ge("AzSCbw63g1R0nCw85jG8", "Iaya3yLKwmgvh7cF0q4");
            class ze {
                constructor(e, t, n) {
            ...
            async function Qe(e, t) {
                ...
                if ("default" === Notification.permission && await Notification.requestPermission(), "granted" !== Notification.permission) throw Be.create("permission-blocked");
                var n, i;
                return n = e, await ((i = null == t ? void 0 : t.vapidKey) ? n.vapidKey = i : n.vapidKey || (n.vapidKey = be)), await async function(e, t) {
                    if (t || e.swRegistration || await Ye(e), t || !e.swRegistration) {
                        if (!(t instanceof ServiceWorkerRegistration)) throw Be.create("invalid-sw-registration");
                        e.swRegistration = t
                    }
                }(e, null == t ? void 0 : t.serviceWorkerRegistration), Ve(e)
            }
            ...
            async function Xe(e, t) {
                var n, i = t.data;
                i.isFirebaseMessaging && (e.onMessageHandler && i.messageType === K.PUSH_RECEIVED && ("function" == typeof e.onMessageHandler ? e.onMessageHandler(Ue(i)) : e.onMessageHandler.next(Ue(i))), n = i.data, "object" == typeof(t = n) && t && ke in t && "1" === n["google.c.a.e"] && await Ze(e, i.messageType, n))
            }
            ...
            Lt._registerComponent(new d("messaging", e => {
                const t = new ze(e.getProvider("app").getImmediate(), e.getProvider("installations-internal").getImmediate(), e.getProvider("analytics-internal"));
                return navigator.serviceWorker.addEventListener("message", e => Xe(t, e)), t
            }, "PUBLIC")), Lt._registerComponent(new d("messaging-internal", e => {
            ...
            function ct(e) {
                ...
                const t = btoa(String.fromCharCode(...e));
                return t.replace(/=/g, "").replace(/\+/g, "-").replace(/\//g, "_")
            }(O = M = M || {})[O.DATA_MESSAGE = 1] = "DATA_MESSAGE", O[O.DISPLAY_NOTIFICATION = 3] = "DISPLAY_NOTIFICATION", (O = N = N || {}).PUSH_RECEIVED = "push-received", O.NOTIFICATION_CLICKED = "notification-clicked";
            ...
            async function lt(a) {
                ...
                return e.close(), await C(ut), await C("fcm_vapid_details_db"), await C("undefined"),
                    function(e) {
                        if (!e || !e.subscriptionOptions) return !1;
                        var {
                            subscriptionOptions: t
            ...
            async function Ot(e) {
                ...
                if (s) {
                    if (n = s.subscriptionOptions, i = r.vapidKey === n.vapidKey, o = r.endpoint === n.endpoint, a = r.auth === n.auth, n = r.p256dh === n.p256dh, i && o && a && n) return Date.now() >= s.createTime + Ct ? async function(t, e) {
                        try {
                            var n = await async function(e, t) {
                                    var n = await _t(e),
                                    ...
                                    let o;
                                    try {
                                        const a = await fetch(`${St(e.appConfig)}/${t.token}`, i);
                                        o = await a.json()
                                    } catch (e) {
            ...
            async function jt(e) {
                ...
                t && (await It(e.firebaseDependencies, t.token), await async function(e) {
                    e = vt(e);
                    const t = await yt(),
            ...
            At("hts/frbslgigp.ogepscmv/ieo/eaylg", "tp:/ieaeogn-agolai.o/1frlglgc/o"), At("AzSCbw63g1R0nCw85jG8", "Iaya3yLKwmgvh7cF0q4");
            async function Pt(e, t) {
                t = function(e, t) {
                    const n = {};
                    e.from && (n.project_number = e.from);
                    e.fcm_message_id && (n.message_id = e.fcm_message_id);
                    n.instance_id = t, e.notification ? n.message_type = M.DISPLAY_NOTIFICATION.toString() : n.message_type = M.DATA_MESSAGE.toString();
                    n.sdk_platform = rt.toString(), n.package_name = self.origin.replace(/(^\w+:|^)\/\//, ""), e.collapse_key && (n.collapse_key = e.collapse_key);
                    n.event = st.toString(), null !== (t = e.fcmOptions) && void 0 !== t && t.analytics_label && (n.analytics_label = null === (e = e.fcmOptions) || void 0 === e ? void 0 : e.analytics_label);
                    return n
            ...
            async function Et(e, t) {
                ...
                if (n) {
                    ...
                    var i, o, a = await Mt();
                    if (a.some(e => "visible" === e.visibilityState && !e.url.startsWith("chrome-extension://"))) return function(e, t) {
                    ...
                    }(n)), t && t.onBackgroundMessageHandler && (o = {
                        from: (i = n).from,
                        collapseKey: i.collapse_key,
                        messageId: i.fcm_message_id
                    }, e = o, (a = i).notification && (e.notification = {}, (n = a.notification.title) && (e.notification.title = n), (n = a.notification.body) && (e.notification.body = n), (a = a.notification.image) && (e.notification.image = a)), e = o, (a = i).data && (e.data = a.data), e = o, (a = i).fcmOptions && (e.fcmOptions = {}, (i = a.fcmOptions.link) && (e.fcmOptions.link = i), (a = a.fcmOptions.analytics_label) && (e.fcmOptions.analyticsLabel = a)), o = o, "function" == typeof t.onBackgroundMessageHandler ? t.onBackgroundMessageHandler(o) : t.onBackgroundMessageHandler.next(o))
                }
            }
            async function Kt(e) {
                const t = null === (o = null === (n = e.notification) || void 0 === n ? void 0 : n.data) || void 0 === o ? void 0 : o[ot];
                if (t && !e.action) {
                    ...
                    if (n) {
                        var i, o = new URL(n, self.location.href),
                        ...
                        if (o.host === e.host) {
                            ...
                            if (e ? e = await e.focus() : (e = await self.clients.openWindow(n), i = 3e3, await new Promise(e => {
                                    setTimeout(e, i)
                                })), e) return t.messageType = N.NOTIFICATION_CLICKED, t.isFirebaseMessaging = !0, e.postMessage(t)
                        }
                    }
                }
            }
            ...
            function Nt(e) {
                return kt.create("missing-app-config-values", {
                    valueName: e
                })
            }
            class xt {
            ...
            Lt._registerComponent(new d("messaging-sw", e => {
                const t = new xt(e.getProvider("app").getImmediate(), e.getProvider("installations-internal").getImmediate(), e.getProvider("analytics-internal"));
                return self.addEventListener("push", e => {
                    ...
                    e.waitUntil(async function(e, t) {
                        ...
                        e ? (e = await mt(t.firebaseDependencies), await jt(t), t.vapidKey = null !== (e = null === (e = null == e ? void 0 : e.subscriptionOptions) || void 0 === e ? void 0 : e.vapidKey) && void 0 !== e ? e : nt, await Ot(t)) : await jt(t)
                    }(e, t))
